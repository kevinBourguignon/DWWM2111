...
<main id="maincontent" role="main">
                ...
                <?php } ?>
		            <div class="carousel-caption">
		              <div class="inner_carousel">
		              	<?php if( get_theme_mod('vw_automobile_lite_slider_title_hide_show',true) != ''){ ?>
		                ...
		                <?php } ?>
		                <?php if( get_theme_mod('vw_automobile_lite_slider_content_hide_show',true) != ''){ ?>
		                	<p class="wow swing delay-1000" data-wow-duration="2s"><?php $excerpt = get_the_excerpt(); echo esc_html( vw_automobile_lite_string_limit_words( $excerpt, esc_attr(get_theme_mod('vw_automobile_lite_slider_excerpt_number','30')))); ?></p>
		                <?php } ?>
	...
	<?php if( get_theme_mod( 'vw_automobile_lite_title') != '' || get_theme_mod( 'vw_automobile_lite_choose_us_category' )!= ''){ ?>
		<section class="darkbox choose_us wow bounceInDown delay-1000" data-wow-duration="3s">
