...
function vw_automobile_lite_scripts() {
	...
	wp_enqueue_style('vw-automobile-lite-effect', esc_url(get_template_directory_uri()).'/css/effect.css');
	...
	wp_enqueue_script('vw-automobile-lite-customs-jquery', esc_url(get_template_directory_uri()).'/js/custom.js', array('jquery'));

	if (get_theme_mod('vw_automobile_lite_animation', true) == true){
		wp_enqueue_script( 'vw-automobile-lite-jquery-wow', esc_url(get_template_directory_uri()) . '/js/wow.js', array('jquery') );
		wp_enqueue_style( 'vw-automobile-lite-animate-css', esc_url(get_template_directory_uri()).'/css/animate.css' );
	}
...
function vw_automobile_lite_tagline_hide_show(){
	if(get_theme_mod('vw_automobile_lite_tagline_hide_show') == '1' ) {
		return true;
	}
	return false;
}
