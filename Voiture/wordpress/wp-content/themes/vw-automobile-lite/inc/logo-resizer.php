...
function vw_automobile_lite_logo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('vw_automobile_lite_logo_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_automobile_lite_logo_padding',array(
		'label'	=> __('Logo Padding','vw-automobile-lite'),
	...
	$wp_customize->add_setting('vw_automobile_lite_logo_margin',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_automobile_lite_logo_margin',array(
		'label'	=> __('Logo Margin','vw-automobile-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-automobile-lite'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'vw-automobile-lite' ),
    ),
  ...
  $wp_customize->add_setting('vw_automobile_lite_site_title_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_automobile_lite_site_title_font_size',array(
		'label'	=> __('Site Title Font Size','vw-automobile-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-automobile-lite'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'vw-automobile-lite' ),
    ),
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'vw_automobile_lite_logo_title_hide_show'
	));
  ...
  $wp_customize->add_setting('vw_automobile_lite_site_tagline_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_automobile_lite_site_tagline_font_size',array(
		'label'	=> __('Site Tagline Font Size','vw-automobile-lite'),
		'description'	=> __('Enter a value in pixels. Example:20px','vw-automobile-lite'),
		'input_attrs' => array(
      'placeholder' => __( '10px', 'vw-automobile-lite' ),
    ),
    'priority'    => 12,
		'section'=> 'title_tagline',
		'type'=> 'text',
		'active_callback' => 'vw_automobile_lite_tagline_hide_show'
	));
}
