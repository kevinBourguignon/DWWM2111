    ...
    <div class="tab-sec">
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = VW_Automobile_Lite_Plugin_Activation_Woo_Products::get_instance();
				$vw_automobile_lite_actions = $plugin_ins->recommended_actions;
				?>
				<div class="vw-automobile-lite-recommended-plugins">
					    <div class="vw-automobile-lite-action-list">
			...
			<?php }else{ ?>
				...
				<div class="vw-automobile-lite-pattern-page">
					...
					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','vw-automobile-lite'); ?></span></b></p>
	              	<div class="vw-automobile-lite-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-automobile-lite'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','vw-automobile-lite'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
