<?php
	...
	$vw_automobile_lite_nav_menus_font_weight = get_theme_mod( 'vw_automobile_lite_navigation_menu_font_weight','Default');
    if($vw_automobile_lite_nav_menus_font_weight == 'Default'){
		$vw_automobile_lite_custom_css .='.main-navigation a{';
			$vw_automobile_lite_custom_css .='';
		$vw_automobile_lite_custom_css .='}';
	}else if($vw_automobile_lite_nav_menus_font_weight == 'Normal'){
		$vw_automobile_lite_custom_css .='.main-navigation a{';
			$vw_automobile_lite_custom_css .='font-weight: normal;';
		$vw_automobile_lite_custom_css .='}';
	}
